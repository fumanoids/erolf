...
#define P2P_USART_INTERFACE USART2


#define P2P_RX_PACKET_SGIN_PORT GPIOA
#define P2P_TX_PACKET_SGIN_PORT GPIOA

#define P2P_RX_PACKET_SGIN_PIN GPIO0
#define P2P_TX_PACKET_SGIN_PIN GPIO1


#define P2P_USART_PORT GPIOA
#define P2P_USART_TX_PIN  GPIO2
#define P2P_USART_RX_PIN  GPIO3

#define P2P_TX_DMA DMA1
#define P2P_RX_DMA DMA1

#define P2P_TX_DMA_STREAM DMA_STREAM_6
...
static void trigger_transmision(void)
{
	...
	if ((0 == (DMA_SCCR(P2P_TX_DMA, P2P_TX_DMA_STREAM) & DMA_CR_EN)) &&
		(bytesToSendCurrently > 0U) &&
...
void usart2_isr(void)
{
	if (0 != (USART_SR(P2P_USART_INTERFACE) & USART_SR_TC))
	{
		...
		g_currentTransmissionCount -= bytesTransmitted;
...
static void p2p_com_init(void)
{
	...
	USART_BRR(P2P_USART_INTERFACE) = CLOCK_APB1_CLK / P2P_USART_INTERFACE_SPEED;
	USART_CR1(P2P_USART_INTERFACE) |= USART_CR1_TE | USART_CR1_RE;
	USART_CR3(P2P_USART_INTERFACE) |= USART_CR3_DMAT | USART_CR3_DMAR;
